...
output "../out/bs_supermariousa_ep2_en.bs", create
seekFile(0); fill $100000,$FF
seekFile(0); insert "../roms/bs_supermariousa_ep2.bs"

include "../asm/bs2_en.asm"

seekAddr($86800C); db 1		//Episode (0-3)
seekAddr($86800E); db 0		//?
seekAddr($86800F); db 0		//?

seekFile(0x7FC0); db "                "
seekFile(0x7FC0); db "BS MARIO 2 EP 2"
