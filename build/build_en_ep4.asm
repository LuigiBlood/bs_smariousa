...
output "../out/bs_supermariousa_ep4_en.bs", create
seekFile(0); fill $100000,$FF
seekFile(0); insert "../roms/bs_supermariousa_ep4.bs"

include "../asm/bs4_en.asm"

seekAddr($86800C); db 3		//Episode (0-3)
seekAddr($86800E); db 0		//?
seekAddr($86800F); db 0		//?

seekFile(0x7FC0); db "                "
seekFile(0x7FC0); db "BS MARIO 2 EP 4"
