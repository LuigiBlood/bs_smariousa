...
echo -- Graphics
echo - en/bg1_en.png
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/bg1_en.png" -p "./gfx/temp/bg1_en.pal" -t "./gfx/temp/bg1_en.chr" -m "./gfx/temp/bg1_en.map" -P 7
echo - bg2.png
...
echo - en/ep1.png
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/ep1.png" -p "./gfx/temp/ep1_en.pal" -t "./gfx/temp/ep1_en.chr" -m "./gfx/temp/ep1_en.map" -B 4 -P 1 --color-zero 000000
echo - en/ep2.png
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/ep2.png" -p "./gfx/temp/ep2_en.pal" -t "./gfx/temp/ep2_en.chr" -m "./gfx/temp/ep2_en.map" -B 4 -P 1 --color-zero 000000
echo - en/ep3.png
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/ep3.png" -p "./gfx/temp/ep3_en.pal" -t "./gfx/temp/ep3_en.chr" -m "./gfx/temp/ep3_en.map" -B 4 -P 1 --color-zero 000000
echo - en/ep4.png
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/ep4.png" -p "./gfx/temp/ep4_en.pal" -t "./gfx/temp/ep4_en.chr" -m "./gfx/temp/ep4_en.map" -B 4 -P 1 --color-zero 000000
echo - en/the_end.png
...
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/credits1.png" -p "./gfx/temp/credits1.pal" -t "./gfx/temp/credits1.chr" -m "./gfx/temp/credits1.map" -B 2 -W 16 -H 16
...
"./tools/conv/superfamiconv.exe" convert -i "./gfx/en/resultsrecord.png" -p "./gfx/temp/resultsrecord.pal" -t "./gfx/temp/resultsrecord.chr" -m "./gfx/temp/resultsrecord.map" -B 2 -W 16 -H 16
echo -- Build ROM...
