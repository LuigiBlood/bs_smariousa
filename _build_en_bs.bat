@echo off
echo Building BS Version... (English Version)
echo -- Graphics
echo - en/bg1_en.png
...
"./tools/bass/bass" ./build/build_en_ep1.asm
echo -- Build ROM (Episode 2)...
"./tools/bass/bass" ./build/build_en_ep2.asm
echo -- Build ROM (Episode 3)...
"./tools/bass/bass" ./build/build_en_ep3.asm
echo -- Build ROM (Episode 4)...
"./tools/bass/bass" ./build/build_en_ep4.asm
echo Done.
pause